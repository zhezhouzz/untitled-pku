...
\include{素材/女主事件/nvzhu}
\include{素材/男主事件/nanzhu}
\include{素材/男主事件/ruxue}
\include{素材/妹妹事件/妹妹}
\include{素材/程序员事件/chengxu}
\include{素材/小事件/深夜食堂苏德比}
\include{素材/小事件/X教授}
\include{素材/舍友事件/sheyou}
...
\multirow{2}{*}{11} & \date{\DTMdate{\mydate+ 75 }} &  男主角入学  & \include{素材/校庆事件/校庆事件}  \\  \cline{3-4}
...
% \include{素材/女主事件/QA}
% % \include{素材/女主事件/恋爱大事件}
% \include{素材/小事件/燕火日常}
% \include{素材/小事件/风纪委员日常}
% \include{素材/男主事件/男主事件大纲}
% \include{素材/程序员事件/程序员事件大纲}
% \include{素材/舍友事件/足球事件大纲}
% \include{素材/设定/设定}
% \include{素材/梗/俏皮话}
